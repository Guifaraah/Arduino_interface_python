...
led_1 = 1  # Variável para definir apenas o estado inicial dos Leds
led_2 = 1
...
def botao():
    ...
    if led_1 == 1:  # quando o botão é acionado, ele está com o valor "1" atribuído a ele
        led_1 = 0   # Para que, quando o botão for acionado de novo o estado do led mude, é necessário atribuir outro valor para a variável
        arduino.write(b'0')  # Quando acionado, o valor '1' é enviado para a porta serial do arduino, fazendo com que a ledVermelha Ligue. Isso está especificado no código no arduino IDE.
        ...
        led_1 = 1
        arduino.write(b'1')  # o 'b' é necessário para que o arduino identifique o número em questão em binário, fazendo assim a correta leitura do valor recebido na porta serial.
...
botao_1 = Button(janela, width=20, text="ENVIAR", command=botao ,background="yellow")
...
botao_2 = Button(janela, width=20, text="ENVIAR", command=botao_2 ,background="yellow")
